...
const typeEnum = {
  ...
  info: 'dark:text-zinc-300  ... dark:bg-zinc-700 ... dark:hover:bg-zinc-600 text-zinc-800 bg-zinc-200 hover:bg-zinc-300 active:bg-zinc-200 dark:active:bg-zinc-700'
}
